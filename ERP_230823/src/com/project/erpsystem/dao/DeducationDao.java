...
public class DeducationDao {
	...
	/**
	 * deducation.txt 파일의 내용을 list에 담는 메소드
	 */
	 ...
	 * 새로운 공제 항목을 추가하는 메소드
	 * @param item 공제항목
	 * @param subscriberRate 사용자부담률
	 * @param companyRate 사업자부담률
	 * @return 추가여부
	 */
