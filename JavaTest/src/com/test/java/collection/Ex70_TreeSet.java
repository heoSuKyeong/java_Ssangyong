...
public class Ex70_TreeSet {
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(set2);	//TreeSet은 자동 정렬된다.
		System.out.println();
		...
		System.out.println(set2.headSet(30));	//exclusive, 30미만의 값
		System.out.println(set2.tailSet(30));	//inclusive, 30이상의 값
		System.out.println(set2.subSet(20, 40));	//20이상 ~ 40미만
		System.out.println();
